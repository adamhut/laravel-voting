        ...
        <header class="flex flex-col md:flex-row  item-center justify-between px-8 py-4">
            ...
            <div class="mt-2 md:mt-0 flex items-center">
                    ...
                    <div class="px-4 md:px-6 py-4 sm:block ">
                        @auth
                            <div class="flex items-center space-x-4">
                                ...
                                <livewire:comment-notifications></livewire:comment-notifications>
                            </div>
                        @else
                ...
                <div>
                    <a href="#">
                        <img
                            src="{{auth()->check() ? auth()->user()->getAvatar():"https://www.gravatar.com/avatar/00000000000000000000000000000000?d=mp"}}"
                            alt="avatar"
