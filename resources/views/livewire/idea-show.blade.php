    ...
    <div class="button-container flex items-center justify-between mt-6">
                        ...
                        <div class="space-y-2">
                            <div>
                                <label class="inline-flex items-center">
                                    <input type="radio" checked="" name="radio-direct"
                                        class="bg-gray-200 border-none text-gray-600" value="1"
                                        data-fillr-id="1998062331">
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input type="radio" name="radio-direct" value="2"
                                        class="bg-gray-200 border-none text-purple" data-fillr-id="1195962757">
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input type="radio" name="radio-direct" value="3"
                                        class="bg-gray-200 border-none text-yellow" data-fillr-id="137245947">
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input type="radio" name="radio-direct" value="3"
                                        class="bg-gray-200 border-none text-green" data-fillr-id="137245947">
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input type="radio" name="radio-direct" value="3"
                                        class="bg-gray-200 border-none text-red" data-fillr-id="137245947">
        ...
        <div class="hidden md:flex items-center space-x-3 ">
            <div class="bg-white font-semibold text-center rounded-xl px-3 py-2 shadow-sm">
                <span class="text-xl leading-snug">{{ $votesCount }}</span>
