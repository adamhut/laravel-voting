    ...
    <ul class="flex uppercase font-semibold border-b-4  pb-3 space-x-10">
        <li>
            <a wire:click.prevent="setStatus('All')" 
                ...
                class=" transition duration-150 ease-in border-b-4 pb-3 hover:border-blue @if($status=='All') border-blue text-gray-900 @endif">All Ideas({{$statusCount['all_statuses']}})</a>
        </li>
        <li>
